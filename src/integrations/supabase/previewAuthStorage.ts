...
export function brokeredPreviewStorage() {
  ...
  // Podgląd nie może blokować pierwszej klatki przez kilka sekund, gdy edytor
  // nie odpowiada. Lokalna kopia jest trwałym fallbackiem Supabase.
  const TIMEOUT = 180;
  ...
  // Retry tylko wtedy, gdy urządzenie nie ma lokalnej kopii sesji.
  let firstGet = true;
