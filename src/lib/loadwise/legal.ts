...
Dane przechowujemy przez okres [DATA_RETENTION_PERIOD] lub do momentu usunięcia konta.

5. Podmiot przetwarzający
Dane przechowywane są w infrastrukturze chmurowej: [SUPABASE_PROCESSOR_INFO].
