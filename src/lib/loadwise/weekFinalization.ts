  ...
  const variants: EnduranceBuild[] = [
    {
      ...
      main: [
        canonicalizeGeneratedExercise({ name: "Tempo conditioning block", exerciseId: "tempo_conditioning_block", prescription: "6–10 × 100 m luźnym tempem", rest: "trucht powrotny", cue: "Równy rytm, kontroluj oddech." }),
        canonicalizeGeneratedExercise({ name: "Easy aerobic run", exerciseId: "easy_aerobic_run", prescription: "2–4 × 4 min, przerwa 2 min", rest: "2 min", cue: "Tempo konwersacyjne, nie na maksa." }),
      ],
    },
    {
