...
import { Home, CalendarDays, ScanEye, Camera, Telescope, User } from "lucide-react";

const items = [
  { to: "/start", label: "Start", icon: Home },
  { to: "/plan", label: "Plan", icon: CalendarDays },
  { to: "/vision-lab", label: "Vision", icon: ScanEye },
  { to: "/aparat", label: "Aparat AI", icon: Camera },
  { to: "/scouting", label: "Analiza", icon: Telescope },
