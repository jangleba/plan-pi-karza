...
const FIFA_AREA: SimSourceReference = {
  label:
    "FIFA Training Centre — Goalkeeping fundamentals: defending the penalty area",
...
const FIFA_TRANSITIONS: SimSourceReference = {
  label:
    "FIFA Training Centre — Managing defensive-offensive-defensive transitions",
...
const FAMILIES: Family[] = [
  {
    ...
    consequences: {
      ...
      secondary:
        "Agresywne wyjście odbiera czas po wyraźnym wypuszczeniu piłki przez napastnika.",
  ...
  },
  {
    ...
    consequences: {
      primary:
        "Wczesny krok przecina tor niskiego dośrodkowania przed napastnikiem.",
      secondary:
        "Cofnięcie ciężaru ciała utrzymuje reakcję na wycofanie w okolice jedenastego metra.",
      reset:
        "Pozycja odniesiona do piłki i bramki nie otwiera bliższego słupka.",
    },
  },
  {
    id: "through-ball",
    ...
    consequences: {
      primary:
        "Przewaga do piłki pozwala przejąć ją przed kontaktem napastnika.",
      secondary:
        "Kontrolowane wyjście zmniejsza bramkę bez przedwczesnego położenia się.",
      reset:
        "Brak przewagi czasowej wymaga utrzymania pozycji i komunikacji ze stoperem.",
    },
  },
  {
    id: "aerial-cross",
    ...
    consequences: {
      primary:
        "Czysty tor i najwyższy punkt pozwalają zakończyć akcję chwytem.",
      secondary:
  ...
  },
  {
    ...
    consequences: {
      primary:
        "Ciężki kontakt jest wyzwalaczem do zdecydowanego przejęcia piłki.",
      secondary:
        "Przy kontroli napastnika cierpliwość utrzymuje bramkarza na nogach.",
      reset:
        "Ruch piłki w bok wymaga korekty kąta, a nie ślepego ataku do przodu.",
    },
  },
  {
    id: "save-or-parry",
    ...
    zoneLabels: [
      "Linia chwytu",
      "Szeroka strefa odbicia",
      "Strefa drugiej piłki",
    ],
    ...
    consequences: {
      ...
      secondary:
        "Trudną piłkę kierujesz szeroko, poza centralną strefę dobitki.",
      reset:
        "Po odbiciu natychmiast wracasz w linię piłki i organizujesz drugą obronę.",
    },
  },
  {
    id: "fast-release",
    ...
    brief:
      "Po chwycie widzisz możliwy kontratak, ale rywale mogą zamknąć pierwsze podanie.",
    ...
    consequences: {
      ...
      secondary:
        "Zamknięty środek otwiera bezpieczne wznowienie na dalszą stronę.",
      reset:
        "Brak czystego celu oznacza kontrolę piłki i odbudowanie ustawienia zespołu.",
    },
  },
  {
    id: "build-up",
    ...
    zoneLabels: [
      "Krótka przewaga",
      "Podanie łamiące linię",
      "Bezpieczna strefa długa",
    ],
    actions: [
      "Graj krótko",
      "Złam linię podaniem",
      "Graj długo w zabezpieczenie",
    ],
    preferred: { stays: "secondary", closes_center: "reset", jumps: "primary" },
    consequences: {
      primary:
        "Doskok uwalnia partnera za pierwszą linią i otwiera bezpieczne podanie krótkie.",
  ...
  },
  {
    ...
    zoneLabels: [
      "Nowa linia strzału",
      "Kontrola dośrodkowania",
      "Wyższa asekuracja",
    ],
    actions: [
      "Ustaw się do strzału",
      "Zarządzaj kolejną piłką",
      "Podnieś linię",
    ],
    preferred: { stays: "primary", closes_center: "secondary", jumps: "reset" },
    consequences: {
      ...
      reset:
        "Po oddaleniu zagrożenia wyższa pozycja skraca przestrzeń za linią obrony.",
    },
  },
];
...
function makeScenario(family: Family, levelIndex: number): SimScenario {
          ...
          reaction,
          {
            ...
            path: preferred
              ? [
                  ...
                  {
                    x: 50 + (actionIndex - 1) * 24,
                    y: 82 - level.pressureShift,
                  },
                ]
              : undefined,
          },
  ...
  const scenario = defineScenario({
    ...
    context: {
      ...
      weights: {
        ...
        body: 1.2,
        progression:
          family.topic === "transition" || family.topic === "press_manipulation"
            ? 1.2
            : 0.8,
        advantage: 1.1,
    ...
    timingMissNote:
      "Spóźniona decyzja odbiera przewagę do piłki i zmusza do reakcji awaryjnej.",
    zoneMissNote:
      "Pozycja nie była odniesiona jednocześnie do piłki, bramki i najgroźniejszego przeciwnika.",
    fallbackConsequence:
      "Brak decyzji w oknie czasowym pozostawia bramkarza pomiędzy pozycjami.",
  });
  ...
  return {
    ...
    bodyMissNote:
      "Bramkarz nie zdążył ustawić barków do piłki przed momentem działania.",
  };
}
